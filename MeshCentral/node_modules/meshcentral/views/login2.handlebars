    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
        <tr>
            <td id="logincell">
                ...
                <div id=loginpanel style="display:none;box-shadow:1px 1px 4px #000;background-color:#F7F8FB;width:421px;height:374.71px;top: 218px;left: 457px;gap: 20px">
                    <form id=loginpanelform method=post>
                        <input type=hidden name=action value=login />
                        <div id=message1></div>
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <p style="width:420px;font-family:Inter;size: 22px;"><h2>Welcome to Remote Desktop Connection</h2></p>
                                <tr>
                                    <td>
                                        <h4>Username</h4>
                                        <input id=username title="Username" style="width:280px;border:1pt;padding:10px;background-color:#FFFFFF;border-color:#D0D5DD;border-radius:4px;" {{{autocomplete}}}="username" placeholder="Username" type=text maxlength=64 name=username onchange=validateLogin(1) onkeyup=validateLogin(1,event) />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h4>Password</h4>
                                        <input id=password title="Password" style="width:280px;border:1pt;padding:10px;background-color:#FFFFFF;border-color:#D0D5DD;border-radius:4px;" {{{autocomplete}}}="current-password" placeholder="Password" type=password maxlength=256 name=password onchange=validateLogin(2) onkeyup=validateLogin(2,event) />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input id=loginButton style="width:300px;border:1pt;padding:10px;background-color:#0D51D9;border-color:#D0D5DD;border-radius:4px;color:#FFF" onclick="submitButtonClicked('loginpanelform')" type=button value="Log In" disabled="disabled" />
                                    </td>
                                </tr>
                            </table>
